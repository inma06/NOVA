...
* */
  ...
  final static private String URL = "https://bongbong.ga/seatCheckIn.php";
  ...
  /*   생성자 ->
     ...
     Listener)
   */
  public CheckInRequest(String userID, String seatNumber, Response.Listener<String> listener) {
