...
public class OAuthSampleActivity extends Activity {
	 ...
	 * client 정보를 넣어준다.
	 */
	private static String OAUTH_CLIENT_ID = "JxA6b_LrDieApTM9opyN";
	private static String OAUTH_CLIENT_SECRET = "5fgba1cOK1";
	private static String OAUTH_CLIENT_NAME = "빡공";
