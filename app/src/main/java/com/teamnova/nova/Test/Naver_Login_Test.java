package com.teamnova.nova.Test;
 ...
 * @author naver
 */
public class Naver_Login_Test extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_naver__login__test);
  ...
  public void onButtonClick(View v) throws Throwable {
    ...
    switch (v.getId()) {
      case R.id.buttonOAuth: {
        mOAuthLoginInstance.startOauthLoginActivity(Naver_Login_Test.this, mOAuthLoginHandler);
        break;
      }
